...
TEST_CASE("Stretchingtest_stretching")
{
  ...
  Mesh_Stretcher stretch_left(left_point, distance, anchor, dims);
  Mesh_Stretcher stretch_right(right_point, distance, anchor, dims);
  ...
  SECTION("Check invalid/no stretches")
  {
    ...
    Mesh_Stretcher dont_stretch(-1, distance, anchor, dims);
    ...
    Mesh_Stretcher stretch_too_big_neg(dims, 1, anchor, dims);
