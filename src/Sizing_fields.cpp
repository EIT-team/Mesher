...
using namespace std;
        ...
        sizing_field_elliptic_electrodes::sizing_field_elliptic_electrodes(Point& origin_in, string path_electrode, Input params)
        {
      ...
      FT sizing_field_elliptic_electrodes::operator()(const Point& p, const int, const Index&) const
